    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.benefitCard}>
        {BENEFITS.map((b, i) => (
          <View
            key={i}
            style={[s.benefitRow, i < BENEFITS.length - 1 && s.benefitBorder]}
          >
            <View style={s.checkCircle}>
              <Check color="#fff" size={12} strokeWidth={3} />
            </View>
      ...
      {/* CTA */}
      <TouchableOpacity
        style={[s.unlockBtn, isLoading && { opacity: 0.6 }]}
...
const s = StyleSheet.create({
  ...
  unlockBtn:     { width: "88%", paddingVertical: 16, backgroundColor: C.blue, borderRadius: 12, alignItems: "center", marginBottom: 14 },
  unlockBtnText: { fontSize: 17, fontWeight: "700", color: "#fff" },
  restoreText:   { fontSize: 13, color: C.text3, textDecorationLine: "underline" },
  disclaimer:    { fontSize: 11, color: "#334155", textAlign: "center", marginTop: 14 },
});