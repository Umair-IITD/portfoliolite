...
//   const currentValue =
//     (parseFloat(qty) || 1) * (parseFloat(curPrice) || 0);

//   // Check if user is over free limit (isPro = false until Step 08)
//   const isPro = false;
...
//       console.error("[AddAsset] save error:", e);
//     } finally {
//       setIsSaving(false);
//     }
//   }
...
//               Free tier: {assetCount}/{FREE_LIMIT} assets used
//               {assetCount >= FREE_LIMIT - 1 ? " · Unlock Pro for unlimited" : ""}
//             </Text>
//           </View>
//         )}
